...
//----------------------on retry sign in--------------------------
    ...
    //----------------------------------------------------
            $this->load->view('jobseeker/retry_sign_in', $data);
            $this->footer();
        }
...
//---------when input values are valid then check for sing in--------
        ...
        //-----------load model----------
            ...
            $query = $this->signin_model->check_user_singin($e_mail,$password);
        //-----------load view-----------
            if($query){
            //----------create sesion data------------
                $session_data = array(
...
//------------------------Forgot Password function---------------
    ...
    //-----------load views using functions-------------
            $this->head($data);
            $this->index_header();
            $this->load->view('jobseeker/forgot_password');
            $this->footer();
        }
//------------------------ Terms of use function---------------
    ...
    //-----------load views using functions-------------
            $this->head($data);
            $this->index_header();
            $this->load->view('jobseeker/terms_of_use');
            $this->footer();
        }
//------------------------ Privacy Policy function---------------
    ...
    //-----------load views using functions-------------
            $this->head($data);
            $this->index_header();
            $this->load->view('jobseeker/privacy_policy');
            $this->footer();
        }
    }
?>