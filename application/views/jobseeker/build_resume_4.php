...
<div class="row">
	...
	<form method="post" id="resume_form">
		...
		<p>Ideal Job Titles</p>
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Ideal Job Title 1" name="ideal_job_title_1" value="<?= $ideal_job_titles[0]['ideal_job_title_1'];?>">
		</div>
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Ideal Job Title 2" name="ideal_job_title_2" value="<?= $ideal_job_titles[0]['ideal_job_title_2'];?>">
		</div>
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Ideal Job Title 3" name="ideal_job_title_3" value="<?= $ideal_job_titles[0]['ideal_job_title_3'];?>">
		</div>
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Ideal Job Title 4" name="ideal_job_title_4" value="<?= $ideal_job_titles[0]['ideal_job_title_4'];?>">
		</div>
		<div class="form-group">
			<input type="text" class="form-control" placeholder="Ideal Job Title 5" name="ideal_job_title_5" value="<?= $ideal_job_titles[0]['ideal_job_title_5'];?>">
		</div>
	</form>
		<div class="clearfix"></div>
		<div class="form-group">
			<input type="submit" class="pull-right theme-btn" form="resume_form" value="Next">
			<input type="submit" class="pull-right theme-btn" onclick="window.location.href='<?= base_url();?>index.php/build_resume/step_3'" value="Previous">
		</div>
		<script type="text/javascript"> 
			$('#next').click(function(){
				$('#resume_form').attr('action', "<?= base_url();?>index.php/build_resume/step_4"); 
			});
			$('#save_draft').click(function(){
				$('#resume_form').attr('action', "<?= base_url();?>index.php/build_resume/save_draft/4"); 
			});
		</script>
	</div>
